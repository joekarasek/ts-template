(function($) {
   ...
   */
  HelloWorldDevs.prototype.marqueeCarousel = function (autoplay, target) {
   ...
   */
  HelloWorldDevs.prototype.googleMap = function (target, center, marker) {
    $(target).gMap({
      address: center,
      maptype: 'ROADMAP',
      zoom: 15,
   ...
   */
  HelloWorldDevs.prototype.scrollToFix = function(target) {
